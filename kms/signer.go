...
const (
	...
	Sign_SHA224_RSA_PKCS1_PSS SignAlgorithm = iota
	Sign_SHA256_RSA_PKCS1_PSS               = iota
	Sign_SHA384_RSA_PKCS1_PSS               = iota
	Sign_SHA512_RSA_PKCS1_PSS               = iota
	Sign_SHA224_RSA                         = iota
	Sign_SHA256_RSA                         = iota
	Sign_SHA384_RSA                         = iota
	Sign_SHA512_RSA                         = iota
	Sign_SHA1_ECDSA                         = iota
	Sign_SHA224_ECDSA                       = iota
	Sign_SHA256_ECDSA                       = iota
